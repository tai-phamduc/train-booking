...
public class LightDarkMode extends JPanel {
	...
	private void init() {
		...
		buttonLight = new JButton("", new FlatSVGIcon("gui/menu/mode/light.svg"));
		buttonDark = new JButton("", new FlatSVGIcon("gui/menu/mode/dark.svg"));
	...
	private void checkStyle() {
		...
		if (isDark) {
			buttonLighDark.setIcon(new FlatSVGIcon("gui/menu/mode/dark.svg"));
		} else {
			buttonLighDark.setIcon(new FlatSVGIcon("gui/menu/mode/light.svg"));
		}
	}
